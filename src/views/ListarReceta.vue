      ...
      <v-container fluid class="pa-6">
            ...
            <v-data-table :headers="headers" :items="recetas" item-value="id" class="elevation-1">
              ...
              <template v-slot:no-data>
                <div class="d-flex flex-column align-center pa-12">
                  <v-icon icon="mdi-clipboard-pulse-outline" size="64" color="grey-lighten-2" class="mb-4"></v-icon>
                  <h3 class="text-h5 font-weight-medium mb-2">No se encontraron recetas</h3>
        ...
        <v-dialog v-model="dialogoDetalle" max-width="800" width="80vw">
          <v-card style="max-height: 70vh; overflow: hidden;">
            ...
            <v-card-text class="dialog-text" style="max-height: 60vh; overflow-y: auto; overflow-x: hidden;">
              ...
              <v-list dense>
                <v-list-item v-for="(detalle, i) in detallesReceta" :key="i">
                  <v-list-item-content>
                    ...
                    <v-alert v-if="detalle.medicamento.indicaciones" type="info" class="pl-3 py-1 mt-1 mb-3"
